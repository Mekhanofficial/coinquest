...
const reviews = [
  {
    ...
    title: "Amy Whyatt",
    description:
      "I've been investing with coinquest for over a year now, and I'm extremely satisfied with their services. The team is knowledgeable, responsive, and always keeps me updated on the latest cryptocurrency trends. Thanks to their expertise, my investments have grown significantly!",
    lineColor: "#FF9E64",
  },
  {
    image: dp2,
    title: "Michel Murphy",
    description:
      "coinquest is the best cryptocurrency investment company I've come across. Their team of professionals guided me through the investment process, answered all my questions, and helped me make informed decisions. I've seen remarkable returns on my investments, and I highly recommend them to anyone looking to enter the world of cryptocurrencies.",
    lineColor: "#2DD4BF",
  },
  {
    image: dp3,
    ...
    description:
      "I can't thank coinquest enough for their exceptional services. Their platform is user-friendly, their investment strategies are well-researched, and their customer support is top-notch. They genuinely care about their clients' success and go the extra mile to ensure we achieve our financial goals. I'm thrilled to be a part of the coinquest community!",
    lineColor: "#60A5FA",
  },
  {
    image: dp4,
  ...
  },
  {
    ...
    title: "Sophia Luther",
    description:
      "Choosing coinquest  was the best decision I made for my cryptocurrency investments. Their team possesses in-depth knowledge of the market, and they tailor their strategies to individual investors' goals. I've experienced significant growth in my portfolio, and I'm grateful for their guidance and support. I wholeheartedly recommend coinquest to anyone seeking reliable and profitable cryptocurrency investments.",
    lineColor: "#60A5FA",
  },
  {
    image: dp6,
    title: "Jeff Botch",
    description:
      "coinquest has provided me with an excellent investment experience. Their platform is intuitive, their investment options are diverse, and their team is professional and friendly. I've witnessed remarkable returns on my investments, and I appreciate the peace of mind that comes with knowing my assets are in capable hands. I couldn't be happier with their services!",
    lineColor: "#F87171",
  },
];
