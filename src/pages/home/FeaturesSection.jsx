...
const features = [
  {
    ...
    description:
      "Get a head start on growing your wealth with coinquest's early cash bonus offer - a limited-time opportunity to earn extra returns on your investment.",
    lineColor: "#FFA726",
  },
  {
    image: px7,
    ...
    description:
      "Enjoy peace of mind with coinquest's state-of-the-art security measures, ensuring your transactions and investments are always protected.",
    lineColor: "#26C6DA",
  },
  {
    image: px8,
    ...
    description:
      "Stay informed with coinquest's transparent reporting system, providing real-time updates on your investment performance.",
    lineColor: "#29B6F6",
  },
  {
    image: px9,
    title: "Low Fees",
    description:
      "coinquest offers some of the lowest fees in the industry, ensuring you keep more of your profits.",
    lineColor: "#AB47BC",
  },
  {
    image: px10,
  ...
  },
  {
    ...
    title: "Global Access",
    description:
      "Access your investments from anywhere in the world with coinquest's globally available platform.",
    lineColor: "#EF5350",
  },
];
