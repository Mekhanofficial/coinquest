...
export default function WhatIscoinquestPage() {
  return (
    <div className="bg-slate-900 flex flex-col md:flex-row items-center justify-center p-8 gap-12 z-50 relative">
      ...
      >
        ...
        <p className="text-gray-400 mb-4">
          coinquest is a leading cryptocurrency investment platform that allows
        ...
        <p className="text-gray-400 mb-4">
          With low fees and reliable mining operations, coinquest ensures your
        ...
        <p className="text-gray-400 mb-6">
          Transparency is at the core of what we do. With coinquest, you'll always
          know exactly how your investments are performing, thanks to our clear
          and detailed reporting.
        </p>
        <p className="text-gray-400 mb-6">
          coinquest Ltd is a registered company in the British Virgin Islands (BVI
