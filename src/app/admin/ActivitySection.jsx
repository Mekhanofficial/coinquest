...
export default function ActivitySection() {
  ...
  useEffect(() => {
    setSummaryPage(1);
  }, [filteredUsers.length, summaryPageSize, search]);

  const summaryTotalPages = Math.max(
    1,
    Math.ceil(filteredUsers.length / summaryPageSize)
  );
  ...
  const paginatedUsers = useMemo(() => {
    ...
    return filteredUsers.slice(start, start + summaryPageSize);
  }, [filteredUsers, summaryPage, summaryPageSize]);
